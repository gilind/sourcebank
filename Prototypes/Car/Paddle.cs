...
namespace Breakout
{
	...
	public class Paddle : Sprite
	{
		...
		protected override void Render(Renderer renderer, Time time)
		{
            ...
            //Line2D line = new Line2D(new Point(xPosition, yPosition), new Point(xPosition, yPosition + 1), Color.Red);

			base.Render(renderer, time);

            renderer.DrawLine(new Point(xPosition, yPosition), new Point(xPosition, yPosition + 1), Color.Red);
		}
